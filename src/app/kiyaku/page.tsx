...
export default function Home() {
  ...
  return (
    <main className={styles.page}>
      <Header h1 position='left' icon={icon} href='/settings'>利用規約</Header>
      <ul className={`${styles.list} inner`}>
        <li className={styles.item}>
          ...
          <div className={styles.textArea}>
            <p className={styles.text}>吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。</p>
            <p className={styles.text}>吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。</p>
          </div>
        </li>
        <li className={styles.item}>
